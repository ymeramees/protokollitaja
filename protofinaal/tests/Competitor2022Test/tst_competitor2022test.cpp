...
class CompetitorTest2022 : public QObject
{
    Q_OBJECT
...
CompetitorTest2022::CompetitorTest2022()
{
...
void CompetitorTest2022::test_createCompetitorFromJsonArray()
{
...
void CompetitorTest2022::test_createCompetitorFromJsonArray_data()
{
...
void CompetitorTest2022::test_createCompetitorFromJsonObject()
{
...
void CompetitorTest2022::test_createCompetitorFromJsonObject_data()
{
...
void CompetitorTest2022::test_createCompetitorFromSavedJsonObject()
{
...
//void CompetitorTest2022::test_handleIgnoredShot()
//{
...
//void CompetitorTest2022::test_handleUnignoredShot()
//{
//    QJsonArray conf = {5, 5, 14};
//    Competitor2022 competitor(1, conf);
//    competitor.setShot(0, Lask(104, 354, -983, true, QTime::currentTime()));
...
//void CompetitorTest2022::test_handleUnignoredShot2()
//{
//    QJsonArray conf = {5, 5, 14};
//    Competitor2022 competitor(1, conf);
//    competitor.setShot(0, Lask(104, 354, -983, true, QTime::currentTime()));
...
QTEST_MAIN(CompetitorTest2022)

#include "tst_competitor2022test.moc"
